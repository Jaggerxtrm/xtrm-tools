...
This project is indexed by GitNexus as **xtrm-tools** (5433 symbols, 8143 relationships, 289 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
