...
| [Install Flow (`xtrm install`)](#install-flow-`xtrm-install`) | **`runPreflight(repoRoot, prune?): Promise<PreflightPlan>`** |
| [Module Reference](#module-reference) | **`runPreflight(repoRoot, prune?): Promise<PreflightPlan>`** |
| [Key Types (`types/config.ts`, `types/models.ts`)](#key-types-`typesconfig.ts`,-`typesmodels.ts`) | 1 |
