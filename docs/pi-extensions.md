...
| Section | Summary |
|---|---|
| [Architecture Overview](#architecture-overview) | Global symlink model — Pi loads from ~/.pi/agent/extensions/ only |
| [Directory Layout](#directory-layout) | `.xtrm/ext-src/` is source; global symlinks point here |
| [Install Commands](#install-commands) | Sync creates symlinks, not copies |
| [Why ext-src](#why-ext-src) | Avoids Pi auto-discovery conflicts in project worktrees |
