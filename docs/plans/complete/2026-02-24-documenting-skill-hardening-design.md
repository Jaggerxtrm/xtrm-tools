---
title: 2026 02 24 Documenting Skill Hardening Design
scope: plans
category: plan
version: 1.0.0
updated: 2026-03-22
...
| Section | Summary |
|---|---|
| [Problem Statement](#problem-statement) | The `/documenting` skill has the right infrastructure (scripts, templates, references) but fails on its core promise: |
| [Approach A — Selected Design](#approach-a-—-selected-design) | Four components that compose into a complete system, modelled on service-skills-set patterns |
| [Architecture](#architecture) | _no summary_ |
| [SKILL.md Workflow Rewrite](#skill.md-workflow-rewrite) | The SKILL |
| [Files to Create / Modify](#files-to-create-modify) | _no summary_ |
| [Non-Goals](#non-goals) | _no summary_ |
<!-- END INDEX -->
