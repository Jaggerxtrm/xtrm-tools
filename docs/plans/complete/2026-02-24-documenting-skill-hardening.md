---
title: 2026 02 24 Documenting Skill Hardening
scope: plans
category: plan
version: 1.0.0
updated: 2026-03-22
...
| Section | Summary |
|---|---|
| [Task 1: Add `tracks:` field to schema and templates](#task-1:-add-`tracks:`-field-to-schema-and-templates) | **Files:** |
| [Purpose](#purpose) | {purpose} |
| [Task 2: INDEX generation in `validate_metadata.py`](#task-2:-index-generation-in-`validate-metadata.py`) | **Files:** |
| [Architecture](#architecture) | Handles the core routing logic for all requests |
| [Hook Wiring](#hook-wiring) | Three hooks fire on session events |
| [Installer](#installer) | Single-purpose script, idempotent |
| [Task 3: Create `drift_detector.py`](#task-3:-create-`drift-detector.py`) | **Files:** |
| [Purpose](#purpose) | Test memory |
| [Purpose](#purpose) | No tracking |
| [Task 4: Add Stop hook to `config/settings.json`](#task-4:-add-stop-hook-to-`configsettings.json`) | **Files:** |
| [Task 5: Migrate existing memories — add `tracks:` frontmatter](#task-5:-migrate-existing-memories-—-add-`tracks:`-frontmatter) | **Files:** |
| [Task 6: Rewrite SKILL.md workflow](#task-6:-rewrite-skill.md-workflow) | **Files:** |
| [Workflow](#workflow) | Review output |
| [Task 7: Run full test suite](#task-7:-run-full-test-suite) | **Step 1: Run all documenting tests** |
| [Summary](#summary) | _no summary_ |
<!-- END INDEX -->
