---
title: 2026 03 04 Install Service Skills Design
scope: plans
category: plan
version: 1.0.0
updated: 2026-03-22
...
| Section | Summary |
|---|---|
| [Goal](#goal) | Enable installing the Service Skill Trinity into any project via npx, without requiring Python or a manual script invoca |
| [Context](#context) | `cli/src/commands/install-service-skills |
| [Architecture](#architecture) | `cli/src/commands/install-service-skills |
| [Files Changed](#files-changed) | _no summary_ |
