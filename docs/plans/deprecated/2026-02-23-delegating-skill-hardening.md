---
title: 2026 02 23 Delegating Skill Hardening
scope: plans
category: architecture
version: 1.0.0
updated: 2026-03-22
description: "Planning document (deprecated)"
---
...
| [Task 1: Rewrite `delegating` skill description](#task-1:-rewrite-`delegating`-skill-description) | **File:** |
| [Task 2: Fix SKILL.md — AskUserQuestion pseudocode → prose](#task-2:-fix-skill.md-—-askuserquestion-pseudocode-→-prose) | **File:** |
| [Task 3: Fix CCS execution — add `env -u CLAUDECODE`](#task-3:-fix-ccs-execution-—-add-`env-u-claudecode`) | **File:** |
| [Task 4: Update `skill-suggestion.py` — add orchestration patterns + CLAUDECODE detection](#task-4:-update-`skill-suggestion.py`-—-add-orchestration-patterns-+-claudecode-detection) | **File:** |
| [Task 5: Sync to `~/.claude/` and verify end-to-end](#task-5:-sync-to-`~.claude`-and-verify-end-to-end) | **Step 1:** Run the CLI sync to push changes to the user's home directory: |
| [Summary of changes](#summary-of-changes) | **What this does NOT change:** |
<!-- END INDEX -->
