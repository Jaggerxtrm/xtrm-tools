...
| Section | Summary |
|---|---|
| [Overview](#overview) | L'hook `skill-suggestion |
| [Come Funziona](#come-funziona) | Quando l'utente invia un prompt: |
| [Principi Chiave](#principi-chiave) | **CRITICAL**: La skill di delegation **DEVE SEMPRE** mostrare un menu AskUserQuestion prima dell'esecuzione |
| [Configuration](#configuration) | Expected results: |
| [Testing](#testing) | Expected results: |
| [Integration with Delegation System](#integration-with-delegation-system) | Vedi: [delegation-architecture |
| [Future Enhancements](#future-enhancements) | _no summary_ |
<!-- END INDEX -->
# Hook System Summary
