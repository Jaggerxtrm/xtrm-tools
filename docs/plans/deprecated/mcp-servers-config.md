...
| Section | Summary |
|---|---|
| [Overview](#overview) | The Jaggers Agent Tools MCP configuration provides a **canonical source** for MCP servers that syncs across all supporte |
| [Configuration Files](#configuration-files) | **Installed by default** - these are the essential servers for all users: |
| [Environment Variables](#environment-variables) | **File:** [`config/ |
| [Format Differences by Agent](#format-differences-by-agent) | The `ConfigAdapter` (`cli/lib/config-adapter |
| [Sync Workflow](#sync-workflow) | 1 |
| [Implementation Details](#implementation-details) | **File:** `cli/lib/config-adapter |
| [Vault Protection](#vault-protection) | During sync, the following keys are **protected** (never overwritten): |
| [Troubleshooting](#troubleshooting) | **Problem:** `uvx: command not found` |
| [Testing](#testing) | _no summary_ |
| [Related Documentation](#related-documentation) | _no summary_ |
| [Changelog](#changelog) | _no summary_ |
<!-- END INDEX -->
