...
| [Current Project Skills](#current-project-skills) | *Note: As of v2 |
| [When To Use Which Skill](#when-to-use-which-skill) | `xtrm install project all` is appropriate when the repository contains mixed stacks and you want full guardrails |
| [Requirements Per Skill](#requirements-per-skill) | For users of the Pi Coding Agent, project skills are now managed via native Pi Extensions |
| [Common Failures and Fixes](#common-failures-and-fixes) | For users of the Pi Coding Agent, project skills are now managed via native Pi Extensions |
| [Per-Skill References](#per-skill-references) | For users of the Pi Coding Agent, project skills are now managed via native Pi Extensions |
| [Related Docs](#related-docs) | For users of the Pi Coding Agent, project skills are now managed via native Pi Extensions |
