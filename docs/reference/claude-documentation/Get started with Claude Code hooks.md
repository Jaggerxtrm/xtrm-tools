...
title: Untitled
date_created: Thursday, January 29th 2026, 1:31:49 pm
date_modified: Thursday, January 29th 2026, 1:32:24 pm
---
scope: reference
category: reference
version: 1.0.0
...
| Section | Summary |
|---|---|
| [Hook Events Overview](#hook-events-overview) | Claude Code provides several hook events that run at different points in the |
| [Quickstart](#quickstart) | In this quickstart, you'll add a hook that logs the shell commands that Claude |
| [More Examples](#more-examples) | <Note> |
| [Learn more](#learn-more) | * For reference documentation on hooks, see [Hooks reference](/en/hooks) |
<!-- END INDEX -->
> ## Documentation Index
