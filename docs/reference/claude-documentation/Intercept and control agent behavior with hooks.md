...
| Section | Summary |
|---|---|
| [Available hooks](#available-hooks) | The SDK provides hooks for different stages of agent execution |
| [Common use cases](#common-use-cases) | Hooks are flexible enough to handle many different scenarios |
| [Configure hooks](#configure-hooks) | To configure a hook for your agent, pass the hook in the `options |
| [Handle advanced scenarios](#handle-advanced-scenarios) | These patterns help you build more sophisticated hook systems for complex use cases |
| [Fix common issues](#fix-common-issues) | This section covers common issues and how to resolve them |
| [Learn more](#learn-more) | _no summary_ |
<!-- END INDEX -->
