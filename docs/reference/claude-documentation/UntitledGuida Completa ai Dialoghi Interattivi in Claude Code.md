...
| Section | Summary |
|---|---|
| [1. Descrizione e Funzionamento](#1.-descrizione-e-funzionamento) | L'interfaccia interattiva di Claude Code non è una semplice chat, ma un sistema di **"Human-in-the-loop"** basato sul Mo |
| [2. Riferimenti Ufficiali](#2.-riferimenti-ufficiali) | Il tool `AskUserQuestion` è il meccanismo ufficiale per creare dialoghi interattivi in Claude Code |
| [3. Come Implementare l'Interattività](#3.-come-implementare-l'interattività) | Il tool `AskUserQuestion` è il meccanismo ufficiale per creare dialoghi interattivi in Claude Code |
| [Interactive Protocol](#interactive-protocol) | **Global Guardrails for Agent Autonomy:** |
| [Interactive Mode](#interactive-mode) | If any issues are detected (e |
| [4. Selezioni Multiple (`multiSelect: true`)](#4.-selezioni-multiple-`multiselect:-true`) | Usa `multiSelect: true` quando l'utente può scegliere più opzioni contemporaneamente |
| [4.5. Multiple Questions con Navigazione TAB 🔥](#4.5.-multiple-questions-con-navigazione-tab-🔥) | **Feature Avanzata:** Quando invochi `AskUserQuestion` con **2+ domande nell'array**, Claude Code crea un'interfaccia co |
| [5. Gestione delle Risposte](#5.-gestione-delle-risposte) | Dopo l'invocazione di `AskUserQuestion`, Claude riceve la risposta nel parametro `answers`: |
| [6. Esempi Pratici dal Progetto Mercury](#6.-esempi-pratici-dal-progetto-mercury) | **Contesto:** L'agente `cme-analyst` rileva che i dati di mercato sono obsoleti (T-2 o più vecchi) |
| [7. Best Practices](#7.-best-practices) | 1 |
| [8. Pattern Comuni](#8.-pattern-comuni) | Esegui questo comando in Claude Code: |
| [9. Testing e Verifica](#9.-testing-e-verifica) | Esegui questo comando in Claude Code: |
| [10. Troubleshooting](#10.-troubleshooting) | **Possibili cause:** |
| [11. Risorse Aggiuntive](#11.-risorse-aggiuntive) | Vedi i file nel progetto Mercury: |
| [12. Changelog Guida](#12.-changelog-guida) | **v2 |
<!-- END INDEX -->
