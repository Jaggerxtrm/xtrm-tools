...
| Section | Summary |
|---|---|
| [Getting started: The `skill-creator` skill](#getting-started:-the-`skill-creator`-skill) | The recommended way to create a new skill is to use the built-in `skill-creator` |
| [Manual skill creation](#manual-skill-creation) | If you prefer to create skills manually: |
| [Skill structure](#skill-structure) | A skill is a directory containing a `SKILL |
| [Workflow](#workflow) | _no summary_ |
<!-- END INDEX -->
