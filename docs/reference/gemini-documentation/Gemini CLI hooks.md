...
date_created: Monday, February 2nd 2026, 1:11:33 pm
date_modified: Monday, February 2nd 2026, 1:11:52 pm
---
scope: reference
category: reference
version: 1.0.0
...
| Section | Summary |
|---|---|
| [What are hooks?](#what-are-hooks?) | Hooks run synchronously as part of the agent loop—when a hook event fires, |
| [Core concepts](#core-concepts) | Hooks are triggered by specific events in Gemini CLI's lifecycle |
| [Configuration](#configuration) | Hooks are configured in `settings |
| [Security and risks](#security-and-risks) | > **Warning: Hooks execute arbitrary code with your user privileges |
| [Managing hooks](#managing-hooks) | Use the CLI commands to manage hooks without editing JSON manually: |
<!-- END INDEX -->
# Gemini CLI hooks
