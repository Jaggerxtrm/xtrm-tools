...
title: Untitled 1
date_created: Sunday, February 8th 2026, 11:59:29 am
date_modified: Sunday, February 8th 2026, 11:59:33 am
---
scope: reference
category: reference
version: 1.0.0
...
| Section | Summary |
|---|---|
| [File locations and precedence](#file-locations-and-precedence) | Gemini CLI discovers commands from two locations, loaded in a specific order: |
| [Naming and namespacing](#naming-and-namespacing) | The name of a command is determined by its file path relative to its `commands` |
| [TOML file format (v1)](#toml-file-format-v1) | Your command definition files must be written in the TOML format and use the |
| [Handling arguments](#handling-arguments) | Custom commands support two powerful methods for handling arguments |
| [Expected Format](#expected-format) | The command follows this format: `/changelog <version> <type> <message>` |
| [Behavior](#behavior) | 1 |
| [Example: A "Pure Function" refactoring command](#example:-a-"pure-function"-refactoring-command) | Let's create a global command that asks the model to refactor a piece of code |
<!-- END INDEX -->
# Custom commands
