---
title: Tdd Ai Empirical Research
scope: reference
category: reference
version: 1.0.0
updated: 2026-03-22
...
| Section | Summary |
|---|---|
| [Conclusione principale](#conclusione-principale) | **Non implementare TDD come default universale di xtrm |
| [Perché TDD-first non regge come default](#perché-tdd-first-non-regge-come-default) | Le migliori prove pro-TDD con LLM (es |
| [Tassonomia degli anti-pattern AI-specifici](#tassonomia-degli-anti-pattern-ai-specifici) | Quattro failure mode che gli agenti mostrano sistematicamente (MasterCodeYoda/test-strategy): |
| [Matrice di selezione della strategia](#matrice-di-selezione-della-strategia) | Situazioni diverse richiedono strategie diverse: |
| [Il modello ibrido raccomandato](#il-modello-ibrido-raccomandato) | La regola del core layer è critica: **nessun mock, passare valori concreti direttamente |
| [Executable specifications — risposta alla domanda aperta](#executable-specifications-—-risposta-alla-domanda-aperta) | > *Il rito di scrivere qualcosa che fallisce prima produce una specifica migliore?* |
| [Pattern di invarianti per property-based testing](#pattern-di-invarianti-per-property-based-testing) | Sei pattern fondamentali validi trasversalmente (0x7067/test-gen, fast-check deepwiki): |
| [Implicazioni concrete per xtrm](#implicazioni-concrete-per-xtrm) | Mantenere come *suggerimento* opzionale quando rileva pattern implementation-heavy |
| [Mossa successiva raccomandata](#mossa-successiva-raccomandata) | Prima di scrivere hook nuovi: **decision matrix su corpus reale** |
| [Riferimenti chiave](#riferimenti-chiave) | **Letteratura empirica:** |
<!-- END INDEX -->
