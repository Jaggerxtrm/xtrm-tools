...
| [Tier Definitions](#tier-definitions) | Contains baseline skills required for bootstrapping and core workflows: `using-xtrm`, `documenting`, `planning`, `test-p |
| [Runtime Active Views](#runtime-active-views) | Each runtime has an **active view** directory: |
| [state.json Schema](#state.json-schema) | The state file is the **source of truth** for runtime enablement |
| [PACK.json Schema](#pack.json-schema) | Located at `<pack-root>/PACK |
