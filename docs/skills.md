...
| Section | Summary |
|---|---|
| [Tier Architecture](#tier-architecture) | The `default/` directory is a symlink to the repo `skills/` directory, providing a live view without copying |
| [xt skills CLI](#xt-skills-cli) | Scope flags: |
| [Default Skills Catalog](#default-skills-catalog) | _no summary_ |
